        ...
        <div className="w-[500px] max-w-[900px] mx-auto p-2.5 bg-white rounded-lg">
            ...
            {!latitude || !longitude ? (
                ...
                <div className="max-w-full overflow-x-auto">
                    <table className="text-[0.85rem] w-full border border-gray-300 text-center ">
                        <tbody>
                            <tr className="border-t">
                                <td className="border p-1 m-0 text-center font-semibold  bg-[rgb(176,242,213)] text-gray-700">🌅 Sunrise</td>
                                <td className="border p-1 m-0">{sunData.sunrise}</td>
                            </tr>
                            <tr className="border-t">
                                <td className="border p-1 m-0 text-center font-semibold  bg-[rgb(176,242,213)] text-gray-700">🟠 Golden Hour</td>
                                <td className="border p-1 m-0">{sunData.golden_hour}</td>
                            </tr>
                            <tr className="border-t">
                                <td className="border p-1 m-0 text-center font-semibold  bg-[rgb(176,242,213)] text-gray-700">🌇 Sunset</td>
                                <td className="border p-1 m-0">{sunData.sunset}</td>
                            </tr>
                            <tr className="border-t">
                                <td className="border p-1 m-0 text-center font-semibold  bg-[rgb(176,242,213)] text-gray-700">☀️ Solar Noon</td>
                                <td className="border p-1 m-0">{sunData.solar_noon}</td>
                            </tr>
                            <tr className="border-t">
                                <td className="border p-1 m-0 text-center font-semibold  bg-[rgb(176,242,213)] text-gray-700">⏳ Day Length</td>
                                <td className="border p-1 m-0">{sunData.day_length}</td>
                            </tr>
                            <tr className="border-t">
                                <td className="border p-1 m-0 text-center font-semibold  bg-[rgb(176,242,213)] text-gray-700">🌄 Dawn</td>
                                <td className="border p-1 m-0">{sunData.dawn}</td>
                            </tr>
                            <tr className="border-t">
                                <td className="border p-1 m-0 text-center font-semibold  bg-[rgb(176,242,213)] text-gray-700">🌆 Dusk</td>
                    ...
                    <div className="p-2">
                        {city && (
                                    <h4 className="text-[1rem] text-center text-[rgb(37,136,93)] mb-2">
